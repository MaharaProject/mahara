...
ifdef simplesamlphp
	...
	@curl -sSL https://github.com/simplesamlphp/simplesamlphp/releases/download/v1.14.3/simplesamlphp-1.14.3.tar.gz | tar  --transform 's/simplesamlphp-[0-9]+\.[0-9]+\.[0-9]+/simplesamlphp/x1' -C htdocs/auth/saml/extlib -xzf -
