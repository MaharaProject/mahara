@javascript @core @core_artefact @core_content @artefact @artefact_comment
...
Scenario: Public comment by page owner, public reply by third party
    ...
    Then I should see "Public comment by pageowner" in the ".commentreplyview" "css_element"

    Given I fill in "Public reply by pagecommenter" in WYSIWYG editor "add_feedback_form_message_ifr"
    And I press "Comment"
...
Scenario: Public comment by non-owner, owner can private reply, another non-owner cannot private reply
    ...
    Given I fill in "Public reply by pagewatcher" in WYSIWYG editor "add_feedback_form_message_ifr"
    And I press "Comment"
...
Scenario: Private comment by commenter, private reply by page owner, private counter-reply by page commenter
    ...
    Then I should see "Private" in the "#add_feedback_form_ispublic_container" "css_element"

    Given I fill in "Private reply by pageowner" in WYSIWYG editor "add_feedback_form_message_ifr"
    And I press "Comment"
    And I log out
    And I log in as "pagecommenter" with password "password"
    And I go to portfolio page "page1"
    ...
    Then I should see "Private reply by pageowner"
