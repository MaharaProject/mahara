...
Scenario: Going to a direct link to a message will open the message directly in the inbox (Bug 1837194)
   ...
   Then I should see "Contact request from Cecilia" in the "#activitylist" "css_element"
   And I should not see "Contact request from Bob" in the "#activitylist" "css_element"
   ...
   And I should see "Contact request from Bob" in the "#activitylist" "css_element"
   And I should not see "Contact request from Cecilia" in the "#activitylist" "css_element"
