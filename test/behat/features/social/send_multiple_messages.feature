...
Scenario: Sending messages between people and admin (Bug 1426983)
   ...
   And I choose "People" in "Engage" from main menu
   And I follow "Angela"
   And I follow "Make contact request"
   #Sending a contact request with more than 255 characters (Bug 1373670)
   And I fill in the following:
   ...
   # Log out as Angela
   And I log out
   #Sending contact requests from student to admin (Bug 1440908)
   ...
   And I follow "Make contact request"
   And I fill in "Would you like to be my contact?" for "Message"
   And I press "Make contact request"
   And I follow "Become Admin Account again"
   And I am on homepage
   # In my inbox block I'll see "New contact request"
   And I choose inbox
   And I expand the section "New contact request"
   # Clicking on the notification title to expand it
   And I follow "Requests"
   And I should see "Would you like to be my contact?"
   And I press "Approve request"
   And I should see "Accepted contact request"
   And I follow "Log in as UserB"
   # In UserA's inbox block I'll see a "Contact request accepted" notification
   And I choose inbox
   And I expand the section "Contact request accepted"
