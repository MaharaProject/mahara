...
Scenario: Admin user log in and confirm Legal templates are correct for
    ...
    When  I choose "Terms and conditions" in "Settings" from account menu
    ...
    # PCNZ customisation: Legal -> Terms and conditions
    And I click on the "First Legal" "Terms and conditions" property
    ...
    # PCNZ customisation: Legal -> Terms and conditions
    And I click on the "Privacy statement Edit icon" "Terms and conditions" property
    ...
    # PCNZ customisation: Legal -> Terms and conditions
    And I click on the "Terms and conditions Edit icon" "Terms and conditions" property
    And I fill in "Version" with "V2.0"
