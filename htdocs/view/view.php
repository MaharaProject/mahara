        ...
        $releaseform = pieform(array(
            ...
            'elements' => array(
                ...
                'submit' => array(
                    ...
                    'value' => $releasecollection ? '<span class="icon icon-unlock left" role="presentation"></span>' . get_string('releasecollection', 'group') : '<span class="icon icon-unlock left" role="presentation"></span>' . get_string('releaseview', 'group'),
                ),
            ),
        ));
    }
