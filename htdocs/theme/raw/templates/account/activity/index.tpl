        ...
        <table id="activitylist" class="fullwidth table table-striped">
            ...
            <tfoot>
                <tr>
                    <td colspan="3"></td>
                    <td class="center">
                        <a href="" data-bs-togglecheckbox="tocheckread">{str section='activity' tag='selectall'}<span class="accessible-hidden sr-only"> {str section='activity' tag='selectallread'}</span></a>
                    </td>
                    <td class="center">
                        <a href="" data-bs-togglecheckbox="tocheckdel">{str section='activity' tag='selectall'} <span class="accessible-hidden sr-only">{str section='activity' tag='selectalldelete'}</span></a>
                    </td>
                </tr>
            </tfoot>
            <tbody>
