...
{elseif $group->membershiptype == 'admin'}
	<li class="admincontrol"><a href="{$WWWROOT}group/edit.php?id={$group->id}" title="{str tag=edit}" class="btn"><span class="btn-edit">{str tag=edit}</span></a>
	<a href="{$WWWROOT}group/delete.php?id={$group->id}" title="{str tag=delete}" class="btn"><span class="btn-del">{str tag=delete}</span></a></li>
