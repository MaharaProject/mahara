...
<div class="panel panel-default panel-body">
    ...
    {if $institutiondata}
        <div id="site-stats-wrap">
            <div class="site-stats-left pbs pts">
            ...
            <div class="panel panel-default double">
                    ...
                    <ul class="nav nav-pills">
                        ...
                        <li{if $subpage == $type} class="active"{/if}>
                            <a {if $subpage == $type}class="current-tab" {/if}href="{$WWWROOT}admin/users/statistics.php?institution={$institutiondata.name}&type={$subpage}">{str tag=$subpage}
                                <span class="accessible-hidden sr-only">({str tag=tab}{if $subpage == $type} {str tag=selected}{/if})</span>
                             </a>
                        </li>
                        {/foreach}
                    </ul>
                ...
                {if $subpagedata.table.csv}
                    ...
                    <span class="icon icon-table"></span> {str tag=exportstatsascsv section=admin}:</span></a>
                {/if}
            </div>
