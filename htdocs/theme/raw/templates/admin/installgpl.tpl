...
along with this program.  If not, see <a href="http://www.gnu.org/licenses/gpl.html">http://www.gnu.org/licenses/</a>.
            ...
            <div class="message">Before you install Mahara, you may want to check out the <a href="https://wiki.mahara.org/wiki/Release_Notes">release notes</a> for this release.</div>
