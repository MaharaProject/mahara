...
{$searchform|safe}
			<table id="adminstitutionslist" class="fullwidth">
				...
				<tr class="{cycle values='r0,r1'}">
                    ...
                    <td class="center s"><a class="btn-manage" href="{$WWWROOT}admin/groups/manage.php?id={$group->id}">{str tag="groupmanage" section="admin"}</a></td>
                    <td class="center s"><a class="btn-del" href="{$WWWROOT}admin/groups/delete.php?id={$group->id}">{str tag="groupdelete" section="admin"}</a></td>
				</tr>
				{/foreach}
				</tbody>
			</table>
