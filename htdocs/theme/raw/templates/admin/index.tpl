...
<div class="panel-items js-masonry" data-masonry-options='{ "itemSelector": ".panel" }'>
    {if $register}
        ...
        <div class="panel panel-success register-site">
            <h3 class="panel-heading">{str tag=registeryourmaharasite section=admin} <span class="icon icon-star pull-right" role="presentation"></span></h3>
            <div class="panel-body">
                {str tag=registeryourmaharasitesummary section=admin args=$WWWROOT}
            </div>
            <a class="panel-footer" href="{$WWWROOT}admin/registersite.php">{str tag=Register section=admin} <span class="icon icon-arrow-circle-right pull-right" role="presentation"></span></a>
        </div>
    ...
    {if $sitedata}
        ...
        <div class="panel panel-info site-stats">
            <h3 class="panel-heading">{$sitedata.name}: {str tag=siteinformation section=admin} <span class="icon icon-area-chart pull-right" role="presentation"></span></h3>
            {include file='admin/stats.tpl' full=0}
            <a class="panel-footer text-small" href="{$WWWROOT}admin/statistics.php">{str tag=viewfullsitestatistics section=admin} <span class="icon icon-arrow-circle-right pull-right" role="presentation"></span></a>
        </div>
    ...
    <div class="panel close-site {if $closed}panel-success{else}panel-danger{/if}">
        {if $closed}
            <h3 class="panel-heading">{str tag=reopensite section=admin} <span class="icon icon-lock pull-right" role="presentation"></span></h3>
            <div class="panel-body">
                <p>{str tag=reopensitedetail section=admin}</p>
                {$closeform|safe}
            </div>
        {else}
            <h3 class="panel-heading">{str tag=closesite section=admin} <span class="icon icon-unlock-alt pull-right" role="presentation"></span></h3>
            <div class="panel-body">
    ...
    <div class="panel panel-default">
        <h3 class="panel-heading">{str tag=configsite section=admin} <span class="icon icon-cogs pull-right" role="presentation"></span></h3>
        <ul class="list-group">
    ...
    <div class="panel panel-default">
        <h3 class="panel-heading">{str tag=configusers section=admin} <span class="icon icon-user pull-right" role="presentation"></span></h3>
        <ul class="list-group">
            <li class="list-group-item">
    ...
    <div class="panel panel-default">
        <h3 class="panel-heading">{str tag=managegroups section=admin} <span class="icon icon-users pull-right" role="presentation"></span></h3>
        <ul class="list-group">
            <li class="list-group-item">
    ...
    <div class="panel panel-default">
        <h3 class="panel-heading">{str tag=manageinstitutions section=admin} <span class="icon icon-university pull-right" role="presentation"></span></h3>
        <ul class="list-group">
            <li class="list-group-item">
    ...
    <div class="panel panel-default">
        <h3 class="panel-heading">{str tag=configextensions section=admin} <span class="icon icon-puzzle-piece pull-right" role="presentation"></span></h3>
        <ul class="list-group">
            <li class="list-group-item">
