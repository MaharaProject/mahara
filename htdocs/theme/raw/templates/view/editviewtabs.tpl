...
<ul class="in-page-tabs edit-view-tabs">
  ...
  <li class="displaymypage"><a href="{$displaylink}{if $new}&new=1{/if}">{str tag=displayview section=view} &raquo;</a></li>
  {if $edittitle}<li class="displaymypage"><a href="{$WWWROOT}view/access.php?id={$viewid}{if $new}&new=1{/if}">{str tag=shareview section=view} &raquo;</a></li>{/if}
</ul>
