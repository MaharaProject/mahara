<div class="pageactions" id="toolbar-buttons">
    ...
    {if $selected == 'content'}
        {if $viewurl}
            <button
                ...
                id='displaypagebtn' type="button" class="btn btn-secondary editviews displaycontent"
                title="{str tag=displayview section=view}">
    ...
    {else}
        <button
            ...
            class="btn btn-secondary editviews editcontent {if $selected == 'content'}active{/if}"
            title="{str tag=editcontent1 section=view}">
