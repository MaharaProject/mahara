                ...
                {foreach from=$sitefonts item=font}
                    <div class="{cycle values='r0,r1'} listrow">
                        ...
                        <ul class="actionlist">
                            ...
                            <li><a class="btn-display" href="javascript:" onclick="window.open('http://www.google.com/webfonts/specimen/{$font.urlencode}','_self')">{str tag="viewfontspecimen" section="skin"}<span class="accessible-hidden">{str tag=viewfontspecimenfor section=skin arg1=$font.title}</span></a></li>
                            {else}
                            <li><a class="btn-display" href="javascript:" onclick="window.open('{$WWWROOT}admin/site/font/specimen.php?font={$font.name}','_self')">{str tag="viewfontspecimen" section="skin"}<span class="accessible-hidden">{str tag=viewfontspecimenfor section=skin arg1=$font.title}</span></a></li>
                            {/if}
