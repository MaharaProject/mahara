...
{if $tags}
    <div class="btn-top-right btn-group btn-group-top">
        <a class="btn btn-default" href="{$WWWROOT}tags.php"><span class="icon icon-lg icon-tag left" role="presentation"></span>{str tag=mytags}</a>
    </div>
...
<div class="deletetag list-group-item">
    <h3 class="list-group-item-heading">
        <span class="icon icon-trash left text-danger" role="presentation"></span>
