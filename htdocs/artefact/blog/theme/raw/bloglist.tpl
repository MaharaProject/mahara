{foreach from=$blogs->data item=blog}
    <tr class="{cycle name=rows values='r0,r1'}">
        <td colspan="2">
            <div class="fr">
                <span class="entries"><a href="{$WWWROOT}artefact/blog/view/index.php?id={$blog->id}">{$blog->postcount}{if $blog->postcount == 1}{str tag=post section=artefact.blog}{else}{str tag=posts section=artefact.blog}{/if}</a></span>
