...
<<<<<<< Updated upstream:htdocs/artefact/blog/theme/default/editpost.tpl
        {$form}
=======
        {$textinputform}
        <div id='uploader'></div>
        ...
        <div id='browsemyfiles' style='display: none;'>
          ...
          <table id='filebrowser' class='tablerenderer fullwidth'>
            <thead><tr>
              <th></th>
        ...
        <table id='attachedfiles' class='tablerenderer fullwidth'>
          <thead><tr>
            <th></th>
            <th>{str section=artefact.file tag=Name}</th>
            <th>{str section=artefact.file tag=Description}</th>
        ...
        <div id='savecancel'>
          ...
          <input type='button' class='cancel' value='{str tag=cancel}' onclick="canceledit()">
        </div>
