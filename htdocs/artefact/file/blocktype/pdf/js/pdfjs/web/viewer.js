...
var PDFViewerApplication = {
  ...
  bindEvents: function bindEvents() {
   ...
   // eventBus.on('openfile', webViewerOpenFile); //remove openfile event
...
var defaultOptions = {
  ...
  imageResourcesPath: {
    value: wwwroot + 'artefact/file/blocktype/pdf/js/pdfjs/images/',
    kind: OptionKind.VIEWER
  },
  maxCanvasPixels: {
    value: 16777216,
  ...
  cMapUrl: {
    value: wwwroot + 'artefact/file/blocktype/pdf/js/pdfjs/web/cmaps/',
    kind: OptionKind.API
  },
  disableAutoFetch: {
    value: false,
  ...
  workerSrc: {
    value: wwwroot + 'artefact/file/blocktype/pdf/js/pdfjs/build/pdf.worker.min.js',
    kind: OptionKind.WORKER
  }
};
{
  ...
  defaultOptions.locale = {
    value: typeof navigator !== 'undefined' ? params.lang : navigator.language,
    kind: OptionKind.VIEWER
  };
