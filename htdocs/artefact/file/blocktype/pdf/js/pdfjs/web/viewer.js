...
function configure(AppOptions) {
  AppOptions.set('imageResourcesPath',wwwroot + 'artefact/file/blocktype/pdf/js/pdfjs/web/images/');
  AppOptions.set('workerSrc', wwwroot + 'artefact/file/blocktype/pdf/js/pdfjs/build/pdf.worker.min.js');
  AppOptions.set('cMapUrl', wwwroot + 'artefact/file/blocktype/pdf/js/pdfjs/web/cmaps/');
  AppOptions.set('cMapPacked', true);
}
...
var PDFViewerApplication = {
  ...
  initialize: function () {
    ...
    _regenerator.default.mark(function _callee(appConfig) {
      ...
      configure(_app_options.AppOptions);
      var appContainer;
...
function webViewerInitialized() {
  ...
  file = fileurl ? fileurl : 'file' in params ? params.file : _app_options.AppOptions.get('defaultUrl');
...
};
{
  ...
  var _ui_utils = __webpack_require__(6);
  var queryString = document.location.search.substring(1);
  var params = _ui_utils.parseQueryString(queryString);
  defaultOptions.locale = {
    value: params.lang ? params.lang : typeof navigator !== 'undefined' ? navigator.language : 'en-US',
    kind: OptionKind.VIEWER
  };
}
