...
_pdfjsLib.PDFJS.ignoreCurrentPositionOnZoom = _pdfjsLib.PDFJS.ignoreCurrentPositionOnZoom === undefined ? false : _pdfjsLib.PDFJS.ignoreCurrentPositionOnZoom;
{
  ...
  _pdfjsLib.PDFJS.locale = params.lang ? params.lang : _pdfjsLib.PDFJS.locale === undefined && typeof navigator !== 'undefined' ? navigator.language : _pdfjsLib.PDFJS.locale;
}
...
function configure(PDFJS) {
  PDFJS.imageResourcesPath = wwwroot + 'artefact/file/blocktype/pdf/js/pdfjs/web/images/';
...
function webViewerInitialized() {
  ...
  file = fileurl ? fileurl : 'file' in params ? params.file : appConfig.defaultUrl;
