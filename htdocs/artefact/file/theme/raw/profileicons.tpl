{include file="header.tpl"}
            ...
            <table id="profileicons" class="hidden tablerenderer fullwidth">
                ...
                <tfoot>
                    <tr>
                        <td colspan="4" class="right"><input id="settings_default" type="submit" class="submit" name="default" value="{str tag="setdefault" section=artefact.file}" tabindex="2"> <input id="settings_delete" type="submit" class="cancel" name="delete" value="{str tag="deleteselectedicons" section=artefact.file}" tabindex="2"></td>
                    </tr>
                </tfoot>
            </table>
