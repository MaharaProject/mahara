...
$string['defaultgroupquotadescription'] = 'You can set the amount of disk space that new groups can use in their file area.';
...
$string['odb'] = 'Openoffice Base database file';
$string['odc'] = 'Openoffice Calc file';
$string['odf'] = 'Openoffice formula file';
$string['odg'] = 'Openoffice graphics file';
$string['odi'] = 'Openoffice image file';
$string['odm'] = 'Openoffice master document file';
$string['odp'] = 'Openoffice Impress file';
$string['ods'] = 'Openoffice Spreadsheet file';
$string['odt'] = 'Openoffice Writer document';
