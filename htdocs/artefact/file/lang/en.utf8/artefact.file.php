...
$string['updateuserquotasdesc2'] = 'Apply the default quota you chose above to all existing accounts.';
...
$string['updategroupquotasdesc2'] = 'Apply the default quota you chose above to all existing groups.';
...
$string['fileisfolder'] = '"{{filename}}" is a folder. To upload a folder, please create a zip archive, upload that, and then use the decompress option below.';
...
$string['maxuploadsize'] = 'Maximum file size: %s';
...
$string['adm_notificationmessage']  = '%s has reached %s%% percent of their %s quota. ';
...
$string['useroverquotathreshold'] = '%s has reached %s%% percent of their %s quota. ';
...
$string['logoxsnotsquare'] = 'The picture you uploaded for the mobile logo does not have the correct dimensions. Please upload a square logo.';
...
$string['fileswillbeextractedintofolder1'] = 'Files will be extracted into folder "%s"';
...
$string['invalidarchivehandle'] = 'Invalid archive file extension.';
$string['cannotopenarchive'] = 'Cannot open the archive file %s.';
$string['cannotreadarchivecontent'] = 'Cannot read the archive content.';
...
$string['notrendertopdf'] = 'This block cannot be rendered normally in the PDF export.';
