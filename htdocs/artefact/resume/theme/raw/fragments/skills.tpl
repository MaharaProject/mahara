...
<table id="skillslist{$suffix}" class="tablerenderer fullwidth">
    ...
    <tr class="{cycle values='r0,r1'}">
        ...
        {if $n->exists}
          <a href="{$WWWROOT}artefact/resume/editgoalsandskills.php?id={$n->id}" title="{str tag=edit}"><img src="{theme_url filename='images/btn_edit.png'}" alt="{str tag=edit}"></a>
        {else}
          <a href="{$WWWROOT}artefact/resume/editgoalsandskills.php?type={$n->artefacttype}" title="{str tag=edit}"><img src="{theme_url filename='images/btn_edit.png'}" alt="{str tag=edit}"></a>
        {/if}
        </td>
    </tr>
    {/foreach}
