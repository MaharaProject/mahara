                    ...
                    'invitegroup' => array (
                        ...
                        'elements'          => array(
                            ...
                            'submit' => array(
                                ...
                                'value' => '<span class="icon icon-paper-plane left" role="presentation"></span>' . get_string('sendinvitation', 'group'),
                            )
                        )
                    )
                ),
                    ...
                    'addgroup' => array (
                        ...
                        'elements'  => array(
                            ...
                            'submit' => array(
                                ...
                                'usebuttontag' => true,
                                'class' => 'btn-sm btn-primary input-group-btn',
                                'value' => '<span class="icon icon-plus left" role="presentation"></span>' . get_string('add'),
                            )
                        )
                    )
                ),
