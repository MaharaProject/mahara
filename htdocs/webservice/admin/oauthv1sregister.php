                ...
                'value' => pieform(array(
                        ...
                        'elements' => array(
                            ...
                            'submit' => array(
                                ...
                                'value' => '<span class="icon icon-pencil icon-lg" role="presentation"></span><span class="sr-only">' . get_string('editspecific', 'mahara', $consumer->id) . '</span>',
                    ...
                    pieform(array(
                        ...
                        'elements' => array(
                            ...
                            'submit' => array(
                                ...
                                'usebuttontag' => true,
                                'class' => 'btn-default btn-xs',
                                'value' => '<span class="icon icon-trash icon-lg text-danger" role="presentation"></span><span class="sr-only">'.get_string('deletespecific', 'mahara', $consumer->id).'</span>',
