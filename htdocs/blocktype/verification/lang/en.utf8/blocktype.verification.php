...
$string['blockcontentdescription'] = 'Write the text of the statement you want to have approved. The reviewer clicks a check box to confirm the statement. If you leave this field empty, enable the comment field so reviewers can write their own statement.';
$string['textdescription'] = 'Write the text of your statement. The reviewer clicks a check box to confirm the statement. If you leave this field empty, enable the comment field so reviewers can write their own statement.';
$string['addcomment'] = 'Add comment';
$string['addcommentdescription'] = 'When you allow a comment, the reviewer has a text field available to add their own statement. This can be used together with a default statement. A comment can be made no matter whether the portfolio is locked or not.';
...
$string['availabletodescription'] = 'Select the role or roles that a reviewer must have to approve the statement. If you leave this field empty, no special role is needed, and anybody who has access to the portfolio can approve the default statement or provide a comment. Roles do not accumulate.';
...
$string['addcommentchecklistnames'] = 'After you have published this statement, you cannot revert it. If you wish to do so, you will need to contact one of the following: %s.';
...
$string['commentformplaceholder'] = '<i>The comment form will appear here when the person who can write a comment views this page.</i>';
