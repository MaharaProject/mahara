...
$string['platformvendorkeyinvalid'] = 'The Platform vendor key was not found in the request. Val';
...
$string['deployment1_idalreadyinuse'] = 'This Basic Launch deployment ID is already in use.';
$string['deployment2_idalreadyinuse'] = 'This NRPS deployment ID is already in use.';
$string['deployment3_idalreadyinuse'] = 'This Deep Link deployment ID is already in use.';
