...
$string['artefacttypesdescription'] = 'Check the artefact types you want to include in the index. Only artefact types that have a hierarchy defined are valid. You will need to reset artefacts in the queue for your changes to take effect.';
...
$string['cronstatedescription'] = 'This allows you to enable or disable indexing of queued items when Cron runs.';
...
$string['indexingrunningtry'] = 'If you know cron is not actually running see ./mash search-reset-cron-lock';
...
$string['passworddescription'] = '(Optional) Password to pass to Elasticsearch 7 via HTTP basic authentication.';
...
$string['usernamedescription'] = '(Optional) Username to pass to Elasticsearch 7 via HTTP basic authentication.';
$string['Users'] = 'People';
