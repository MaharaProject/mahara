...
$manual_link_map = array(
    ...
    "engage|find" => "groups/find_group.html",
    ...
    "engage|mygroups" => "groups/my_groups.html",
    "engage|mygroups|blocks" => "groups/inside_group.html#id3",
    "engage|mygroups|edittopic|forums" => "groups/inside_group.html#add-a-forum-topic",
    "engage|mygroups|editpost|forums" => "groups/inside_group.html#reply-to-a-topic-or-subsequent-post",
    "engage|mygroups|forums" => "groups/inside_group.html#set-up-a-new-forum",
    "engage|mygroups|groupviews" => "groups/inside_group.html#pages-and-collections",
    "engage|mygroups|index|forums" => "groups/inside_group.html#forums",
    "engage|mygroups|info" => "groups/inside_group.html",
    "engage|mygroups|members" => "groups/inside_group.html#members",
    "engage|mygroups|view|forums" => "groups/inside_group.html#add-a-forum-topic",
    "engage|mygroups|topic|forums" => "groups/inside_group.html#add-a-forum-topic",
