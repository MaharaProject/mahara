...
$string['group'] = 'You have been invited to join this group';
$string['group'] = 'You have not been invited to join this group';
$string['group'] = 'Invite accepted successfully! You are now a group member';
$string['group'] = 'Invite declined successfully!';
...
$string['group'] = 'Group membership request sent';
$string['couldnotrequestgroup'] = 'Could not send group membership request';
$string['group'] = 'Membership to this group is open';
$string['group'] = 'Membership to this group  is controlled.  You cannot join this group';
$string['group'] = 'Membership to this group is invite only';
$string['group'] = 'Membership to this group is by request only';
$string['group'] = 'New group membership request';
$string['group'] = '%s has sent a membership request to join the group %s';
$string['group'] = '%s has sent a membership request to join the group %s with the reason %s.';
$string['group'] = 'Are you sure you wish to delete this group?';
$string['group'] = 'Are you sure you wish to delete this group? Some of your views use this group for access control, removing this group would mean that the members of that group would not have access to the views.';
