...
$string['editaccesspagedescription4'] = '<p>You are the only one who can see your pages and collections by default. On this page you decide who shall have access to them besides you. Click the "Add" buttons next to the groups and people with whom you wish to share your pages.</p> <p>Click the help icon for more detailed information.</p>';
