...
$string['shorttitledesc'] = 'Enter a short title for our outcome to be used as a short heading. Maximum of 70 characters.';
...
$string['incompleteoutcome'] = 'Click to mark outcome \'%s\' as completed';
$string['completeoutcomeaction'] = 'Outcome \'%s\' has been completed. Click to reset.';
$string['incompleteoutcomeaction'] = 'Click to mark outcome \'%s\' as completed';
$string['supporttitle'] = 'Support taking place';
$string['outcomeupdated'] = 'Outcome has been updated';
$string['outcomeupdatefailed'] = 'Outcome update failed';
$string['progress'] = 'Progress';
$string['markcomplete'] = 'Are you sure you want to mark this outcome as complete?';
$string['markincomplete'] = 'Are you sure you want to remove the complete status from this outcome?';
