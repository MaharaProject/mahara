...
$string['Roles1'] = 'Group type and roles';
$string['Open'] = 'Open';
...
$string['membershipopencontrolled']  = 'Membership cannot be open and controlled at the same time.';
$string['membershipopenoutcomes']  = 'Membership cannot be open when it is an outcomes group.';
$string['membershipopenrequest']     = "Open membership groups do not accept membership requests.";
$string['membershipoutcomesnotcontrolled']     = "Membership must be controlled when it is an outcomes group.";
