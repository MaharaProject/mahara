...
$string['makeusersintoadmins'] = 'Turn selected people into administrators';
$string['makeadminsintousers'] = 'Turn selected administrators back into normal accounts';
...
$string['allowanonymouspagesdescription1'] = 'People can choose to hide their name as the author of a page from others. Administrators will still be able to see the author\'s name if they so desire.';
...
$string['defaultaccountinactivewarndescription1'] = 'The time before accounts are to expire or become inactive at which a warning message will be sent to the primary email address of the account holder.';
...
$string['sessionlifetimedescription'] = 'Time in minutes after which an inactive logged-in person will be automatically logged out.';
...
$string['wysiwygdescription'] = 'Defines whether or not the HTML editor is enabled globally or whether people are allowed to enable / disable it themselves.';
...
$string['defaultmultipleblogsdescription1'] = 'Allow people to have multiple journals by default. They can override this in their account settings page.';
...
$string['uploadcsverrorduplicateremoteuser'] = 'Line %s of the file specifies a remote username "%s" that is already taken by somebody else.';
$string['uploadcsverrorremoteusertaken'] = 'Line %s of the file specifies a remote username "%s" that is already taken by "%s".';
...
$string['uploadcsvfailedusersexceedmaxallowed'] = 'Nobody have been added because there are too many people in your file. The number of members in the institution would have exceeded the maximum number allowed.';
...
$string['forcepasswordchangedescription'] = 'The person will be directed to a "Change password" page the next time they login.';
...
$string['withselectedusers'] = 'With selected people';
...
$string['selectedusers'] = 'Selected people';
...
$string['userreportsdescription'] = 'View or download information about the people you selected on the search page.';
...
$string['progressbardisablednote'] = '<b>Note</b>: Profile completion is currently disabled. You will need to enable it in the "User settings" section of "<a href="%sadmin/site/options.php">Configure site</a>" before people can track their progress towards completing their profile.';
...
$string['denyuserdeletionmessage'] = 'If you continue, you will not approve the deletion of the account. Please provide a reason.';
