...
var wordcount = (function () {
  ...
  var $_geo6b7tjjkvriocb = {
    each: each,
    map: map
  };

  var SETS$1 = $_9einzcthjkvrioc6.SETS;
  var OTHER = $_9einzcthjkvrioc6.characterIndices.OTHER;
  ...
  var classify = function (string) {
    ...
    return $_geo6b7tjjkvriocb.map(string.split(''), memoized);
  };
  var $_1comatijkvrioc9 = { classify: classify };

  var ci = $_9einzcthjkvrioc6.characterIndices;
  ...
  var $_ckl3y0tkjkvriocc = { isWordBoundary: isWordBoundary };

  var EMPTY_STRING$1 = $_9einzcthjkvrioc6.EMPTY_STRING;
  var WHITESPACE$1 = $_9einzcthjkvrioc6.WHITESPACE;
  var PUNCTUATION$1 = $_9einzcthjkvrioc6.PUNCTUATION;
  ...
  var doGetWords = function (str, options) {
    var i = 0;
    var map = $_1comatijkvrioc9.classify(str);
    var len = map.length;
    var word = [];
    var words = [];
    var chr;
    ...
    for (; i < len; ++i) {
      chr = str.charAt(i);
      word.push(chr);
      if ($_ckl3y0tkjkvriocc.isWordBoundary(map, i)) {
  ...
  var $_c6u7swtgjkvrioc1 = { getWords: getWords };

  var getTextContent = function (editor) {
    return editor.removed ? '' : editor.getBody().innerText;
  };
  var getCount = function (editor) {
    return $_c6u7swtgjkvrioc1.getWords(getTextContent(editor)).length;
  };
  var $_1rob8utfjkvriobz = { getCount: getCount };

  var get = function (editor) {
    var getCount = function () {
      return $_1rob8utfjkvriobz.getCount(editor);
    };
    return { getCount: getCount };
  };
  var $_cdh7qktejkvriobz = { get: get };
  ...
  var setup = function (editor) {
    var wordsToText = function (editor) {
      return global$2.translate([
        '{0} words',
        $_1rob8utfjkvriobz.getCount(editor)
      ]);
    };
    var update = function () {
  ...
  var $_2pmwpvtljkvrioce = { setup: setup };

  global.add('wordcount', function (editor) {
    $_2pmwpvtljkvrioce.setup(editor);
    return $_cdh7qktejkvriobz.get(editor);
  });
  function Plugin () {
  }
