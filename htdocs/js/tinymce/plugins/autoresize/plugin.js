...
var autoresize = (function () {
  ...
  var resize = function (editor, oldSize) {
    ...
    body = doc.body;
    resizeHeight = $_5lsvr293jkvrikgf.getAutoResizeMinHeight(editor);
    ...
    if (myHeight > $_5lsvr293jkvrikgf.getAutoResizeMinHeight(editor)) {
      resizeHeight = myHeight;
    }
    var maxHeight = $_5lsvr293jkvrikgf.getAutoResizeMaxHeight(editor);
  ...
  var setup = function (editor, oldSize) {
    editor.on('init', function () {
      ...
      var dom = editor.dom;
      overflowPadding = $_5lsvr293jkvrikgf.getAutoResizeOverflowPadding(editor);
      bottomMargin = $_5lsvr293jkvrikgf.getAutoResizeBottomMargin(editor);
    ...
    if ($_5lsvr293jkvrikgf.shouldAutoResizeOnInit(editor)) {
      editor.on('init', function () {
  ...
  var register = function (editor, oldSize) {
    editor.addCommand('mceAutoResize', function () {
      $_99tlsb90jkvrikgc.resize(editor, oldSize);
    });
  };
  var $_bl2fb88zjkvrikga = { register: register };

  global.add('autoresize', function (editor) {
    if (!editor.inline) {
      var oldSize = Cell(0);
      $_bl2fb88zjkvrikga.register(editor, oldSize);
      $_99tlsb90jkvrikgc.setup(editor, oldSize);
    }
  });
  function Plugin () {
  }
