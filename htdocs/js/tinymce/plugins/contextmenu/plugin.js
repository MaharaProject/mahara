...
var contextmenu = (function () {
  ...
  var $_couwamavjkvrikoe = { getPos: getPos };
  ...
  var renderMenu = function (editor, visibleState) {
    ...
    var items = [];
    contextmenu = $_ajerq2aujkvrikod.getContextMenu(editor);
  ...
  var $_fwucsiayjkvrikoi = { show: show };

  var isNativeOverrideKeyEvent = function (editor, e) {
    return e.ctrlKey && !$_ajerq2aujkvrikod.shouldNeverUseNative(editor);
  };
  var setup = function (editor, visibleState, menu) {
    editor.on('contextmenu', function (e) {
      ...
      e.preventDefault();
      $_fwucsiayjkvrikoi.show(editor, $_couwamavjkvrikoe.getPos(editor, e), visibleState, menu);
    });
  };
  var $_4pbl4datjkvrikob = { setup: setup };

  global.add('contextmenu', function (editor) {
    var menu = Cell(null), visibleState = Cell(false);
    $_4pbl4datjkvrikob.setup(editor, visibleState, menu);
    return $_7wb1n3asjkvrikoa.get(visibleState);
  });
  function Plugin () {
  }
