...
var preview = (function () {
  ...
  var getPreviewHtml = function (editor) {
    ...
    var contentStyle = $_gdfq9fjfjkvrilx1.getContentStyle(editor);
  ...
  var open = function (editor) {
    ...
    var dialogWidth = $_gdfq9fjfjkvrilx1.getPreviewDialogWidth(editor);
    var dialogHeight = $_gdfq9fjfjkvrilx1.getPreviewDialogHeight(editor);
    editor.windowManager.open({
      ...
      onPostRender: function (e) {
        ...
        $_5c9fs3jgjkvrilx2.injectIframeContent(editor, iframeElm, sandbox);
      }
    });
  };
  var $_dyo66rjdjkvrilwz = { open: open };

  var register = function (editor) {
    editor.addCommand('mcePreview', function () {
      $_dyo66rjdjkvrilwz.open(editor);
    });
  };
  var $_d50chjjcjkvrilwy = { register: register };
  ...
  var $_8qivfejijkvrilx5 = { register: register$1 };

  global.add('preview', function (editor) {
    $_d50chjjcjkvrilwy.register(editor);
    $_8qivfejijkvrilx5.register(editor);
  });
  function Plugin () {
  }
