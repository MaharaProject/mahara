...
var toc = (function () {
  ...
  var $_a8e23tsbjkvrio7e = { create: create };

  var tocId = $_a8e23tsbjkvrio7e.create('mcetoc_');
  ...
  var readHeaders = function (editor) {
    var tocClass = $_4ee3vssajkvrio7d.getTocClass(editor);
    var headerTag = $_4ee3vssajkvrio7d.getTocHeader(editor);
    var selector = generateSelector($_4ee3vssajkvrio7d.getTocDepth(editor));
  ...
  var generateTocHtml = function (editor) {
    ...
    return '<div class="' + editor.dom.encode($_4ee3vssajkvrio7d.getTocClass(editor)) + '" contenteditable="false">' + html + '</div>';
  };
  var generateTocContentHtml = function (editor) {
    ...
    html += generateTitle($_4ee3vssajkvrio7d.getTocHeader(editor), global$2.translate('Table of Contents'));
    for (i = 0; i < headers.length; i++) {
      h = headers[i];
      h.element.id = h.id;
  ...
  var register = function (editor) {
    editor.addCommand('mceInsertToc', function () {
      $_zw43hs6jkvrio78.insertToc(editor);
    });
    editor.addCommand('mceUpdateToc', function () {
      $_zw43hs6jkvrio78.updateToc(editor);
    });
  };
  var $_2e3sk4s5jkvrio77 = { register: register };

  var setup = function (editor) {
    var $ = editor.$, tocClass = $_4ee3vssajkvrio7d.getTocClass(editor);
  ...
  var $_ge63d6scjkvrio7f = { setup: setup };

  var toggleState = function (editor) {
    return function (e) {
      var ctrl = e.control;
      editor.on('LoadContent SetContent change', function () {
        ctrl.disabled(editor.readonly || !$_zw43hs6jkvrio78.hasHeaders(editor));
      });
    };
  };
  var isToc = function (editor) {
    return function (elm) {
      return elm && editor.dom.is(elm, '.' + $_4ee3vssajkvrio7d.getTocClass(editor)) && editor.getBody().contains(elm);
    };
  };
  ...
  var $_b7ptmysdjkvrio7g = { register: register$1 };

  global.add('toc', function (editor) {
    $_2e3sk4s5jkvrio77.register(editor);
    $_b7ptmysdjkvrio7g.register(editor);
    $_ge63d6scjkvrio7f.setup(editor);
  });
  function Plugin () {
  }
