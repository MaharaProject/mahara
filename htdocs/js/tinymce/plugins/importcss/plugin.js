...
var importcss = (function () {
  ...
  var defaultConvertSelectorToFormat = function (editor, selectorText) {
    ...
    if ($_bwc7dvfcjkvrilgu.shouldMergeClasses(editor) !== false) {
  ...
  var isExclusiveMode = function (editor, group) {
    return group === null || $_bwc7dvfcjkvrilgu.shouldImportExclusive(editor) !== false;
  };
  ...
  var convertSelectorToFormat = function (editor, plugin, selector, group) {
    ...
    } else if ($_bwc7dvfcjkvrilgu.getSelectorConverter(editor)) {
      selectorConverter = $_bwc7dvfcjkvrilgu.getSelectorConverter(editor);
    } else {
  ...
  var setup = function (editor) {
    editor.on('renderFormatsMenu', function (e) {
      ...
      var selectorFilter = compileFilter($_bwc7dvfcjkvrilgu.getSelectorFilter(editor)), ctrl = e.control;
      var groups = compileUserDefinedGroups($_bwc7dvfcjkvrilgu.getCssGroups(editor));
      ...
      if (!$_bwc7dvfcjkvrilgu.shouldAppend(editor)) {
        ctrl.items().remove();
      }
      global$4.each(getSelectors(editor, e.doc || editor.getDoc(), compileFilter($_bwc7dvfcjkvrilgu.getFileFilter(editor))), function (selector) {
  ...
  var get = function (editor) {
    var convertSelectorToFormat = function (selectorText) {
      return $_4wtpfof7jkvrilgo.defaultConvertSelectorToFormat(editor, selectorText);
    };
    return { convertSelectorToFormat: convertSelectorToFormat };
  };
  var $_356i0nf6jkvrilgm = { get: get };

  global.add('importcss', function (editor) {
    $_4wtpfof7jkvrilgo.setup(editor);
    return $_356i0nf6jkvrilgm.get(editor);
  });
  function Plugin () {
  }
