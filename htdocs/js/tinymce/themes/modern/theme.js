...
var modern = (function () {
  ...
  var $_bttf4vu0jkvriodh = { addKeys: addKeys };
  ...
  var addContextualToolbars = function (editor) {
    ...
    var reposition = function (match, shouldShow) {
      ...
      var delta = $_esoslou4jkvriodp.getUiContainerDelta(panel).getOr({
        x: 0,
        y: 0
      });
    ...
    var bindScrollEvent = function (panel) {
      if (!scrollContainer) {
        ...
        var uiContainer_1 = $_esoslou4jkvriodp.getUiContainer(panel);
    ...
    var showContextToolbar = function (match) {
      ...
      panel = global$4.create({
        ...
        fixed: true,
        border: 1,
        items: $_1c7fslu7jkvriodx.createToolbar(editor, match.toolbar.items),
        oncancel: function () {
          editor.focus();
        }
      });
      $_esoslou4jkvriodp.setUiContainer(editor, panel);
  ...
  var $_echpeeu1jkvriodj = { addContextualToolbars: addContextualToolbars };
  ...
  var $_frzsisu8jkvrioe0 = { createMenuButtons: createMenuButtons };
  ...
  var resizeTo = function (editor, width, height) {
    ...
    $_ctxf2wtzjkvriodg.fireResizeEditor(editor);
  };
  var resizeBy = function (editor, dw, dh) {
    var elm = editor.getContentAreaContainer();
    resizeTo(editor, elm.clientWidth + dw, elm.clientHeight + dh);
  };
  var $_9zs93aubjkvrioeb = {
    resizeTo: resizeTo,
    resizeBy: resizeBy
  };
  ...
  var fireSkinLoaded$1 = function (editor) {
    var done = function () {
      ...
      $_ctxf2wtzjkvriodg.fireSkinLoaded(editor);
    };
    return function () {
      if (editor.initialized) {
        done();
  ...
  var $_755r8uuejkvrioef = { fireSkinLoaded: fireSkinLoaded$1 };
  ...
  var editAreaContainer = function (editor) {
    return {
      ...
      items: [
        editArea('0'),
        $_douajjucjkvrioed.createSidebar(editor)
      ]
    };
  };
  var render = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM$2.styleSheetLoader.load(args.skinUiCss, $_755r8uuejkvrioef.fireSkinLoaded(editor));
    } else {
      $_755r8uuejkvrioef.fireSkinLoaded(editor)();
    }
      ...
      items: [
        {
          ...
          items: [
            hasMenubar(editor) === false ? null : {
              type: 'menubar',
              border: '0 0 1 0',
              items: $_frzsisu8jkvrioe0.createMenuButtons(editor)
            },
            $_1c7fslu7jkvriodx.createToolbars(editor, getToolbarSize(editor))
          ]
        },
        $_douajjucjkvrioed.hasSidebar(editor) ? editAreaContainer(editor) : editArea('1 0 0 0')
      ]
    });
    $_esoslou4jkvriodp.setUiContainer(editor, panel);
      ...
      resizeHandleCtrl = {
        ...
        onResize: function (e) {
          if (getResize(editor) === 'both') {
            $_9zs93aubjkvrioeb.resizeTo(editor, startSize.width + e.deltaX, startSize.height + e.deltaY);
          } else {
            $_9zs93aubjkvrioeb.resizeTo(editor, null, startSize.height + e.deltaY);
          }
        }
      };
    }
    ...
    $_ctxf2wtzjkvriodg.fireBeforeRenderUI(editor);
    ...
    $_bttf4vu0jkvriodh.addKeys(editor, panel);
    $_echpeeu1jkvriodj.addContextualToolbars(editor);
    return {
      iframeContainer: panel.find('#iframe')[0].getEl(),
      editorContainer: panel.getEl()
    };
  };
  var $_93yhgtvjkvriod9 = { render: render };
  ...
  function calculateRelativePosition(ctrl, targetElm, rel) {
    ...
    pos = funcs.getPos(targetElm, $_esoslou4jkvriodp.getUiContainer(ctrl));
    x = pos.x;
    y = pos.y;
  ...
  var getViewPortRect = function (ctrl) {
    var customUiContainer = $_esoslou4jkvriodp.getUiContainer(ctrl);
    return customUiContainer && !isFixed(ctrl) ? getUiContainerViewPort(customUiContainer) : getWindowViewPort();
  };
  var $_fzqoxaukjkvrioff = {
    ...
    moveTo: function (x, y) {
      ...
      var uiContainer = $_esoslou4jkvriodp.getUiContainer(self$$1);
  ...
  var proto$1 = {
    ...
    init: function (settings) {
      ...
      self$$1.borderBox = $_696ocauqjkvriogc.parseBox(settings.border);
      self$$1.paddingBox = $_696ocauqjkvriogc.parseBox(settings.padding);
      self$$1.marginBox = $_696ocauqjkvriogc.parseBox(settings.margin);
      if (settings.hidden) {
        self$$1.hide();
      }
    },
    ...
    getContainerElm: function () {
      var uiContainer = $_esoslou4jkvriodp.getUiContainer(this);
    ...
    initLayoutRect: function () {
      ...
      borderBox = self$$1.borderBox = self$$1.borderBox || $_696ocauqjkvriogc.measureBox(elm, 'border');
      self$$1.paddingBox = self$$1.paddingBox || $_696ocauqjkvriogc.measureBox(elm, 'padding');
      self$$1.marginBox = self$$1.marginBox || $_696ocauqjkvriogc.measureBox(elm, 'margin');
  ...
  var render$1 = function (editor, theme, args) {
    ...
    if (isSkinDisabled(editor) === false && args.skinUiCss) {
      DOM.styleSheetLoader.load(args.skinUiCss, $_755r8uuejkvrioef.fireSkinLoaded(editor));
    } else {
      $_755r8uuejkvrioef.fireSkinLoaded(editor)();
    }
    return {};
  };
  var $_dnvtaoufjkvrioeh = { render: render$1 };
  ...
  var $_53k4umv2jkvrioh9 = { setup: setup };
  ...
  var renderUI = function (editor, theme, args) {
    ...
    $_53k4umv2jkvrioh9.setup(editor, theme);
    return isInline(editor) ? $_dnvtaoufjkvrioeh.render(editor, theme, args) : $_93yhgtvjkvriod9.render(editor, theme, args);
  };
  var $_fa4c1atrjkvriod4 = { renderUI: renderUI };

  var Tooltip = Control$1.extend({
    Mixins: [$_fzqoxaukjkvrioff],
  ...
  var Widget = Control$1.extend({
    ...
    tooltip: function () {
      if (!this._tooltip) {
        ...
        $_esoslou4jkvriodp.inheritUiContainer(this, this._tooltip);
  ...
  var Window$$1 = FloatPanel.extend({
    ...
    fullscreen: function (state) {
      ...
      if (state !== self$$1._fullscreen) {
        ...
        if (!state) {
          self$$1.borderBox = $_696ocauqjkvriogc.parseBox(self$$1.settings.border);
          ...
          self$$1.borderBox = $_696ocauqjkvriogc.parseBox('0');
  ...
  var get = function (editor) {
    var renderUI = function (args) {
      return $_fa4c1atrjkvriod4.renderUI(editor, this, args);
    };
    var resizeTo = function (w, h) {
      return $_9zs93aubjkvrioeb.resizeTo(editor, w, h);
    };
    var resizeBy = function (dw, dh) {
      return $_9zs93aubjkvrioeb.resizeBy(editor, dw, dh);
    };
  ...
  var isComment = function (element) {
    return type(element) === $_djmpcaw5jkvriol8.COMMENT || name(element) === '#comment';
  };
  var isElement = isType$1($_djmpcaw5jkvriol8.ELEMENT);
  var isText = isType$1($_djmpcaw5jkvriol8.TEXT);
  var isDocument = isType$1($_djmpcaw5jkvriol8.DOCUMENT);
  var $_fxwbnuw4jkvriol7 = {
    name: name,
    type: type,
    value: value,
    isElement: isElement,
  ...
  var inBody = function (element) {
    var dom = $_fxwbnuw4jkvriol7.isText(element) ? element.dom().parentNode : element.dom();
  ...
  var $_dv520kwcjkvriom2 = { toArray: toArray };
  ...
  var $_5bo7hgwfjkvriomf = { getOrDie: getOrDie };

  var node = function () {
    var f = $_5bo7hgwfjkvriomf.getOrDie('Node');
    return f;
  };
  ...
  var unknown$1 = function () {
    return nu$1({
      current: undefined,
      version: $_4gp0bywljkvriomr.unknown()
    });
  };
  ...
  var detectBrowser = function (browsers, userAgent) {
    return detect$1(browsers, userAgent).map(function (browser) {
      var version = $_4gp0bywljkvriomr.detect(browser.versionRegexes, userAgent);
      return {
  ...
  var detectOs = function (oses, userAgent) {
    return detect$1(oses, userAgent).map(function (os) {
      var version = $_4gp0bywljkvriomr.detect(os.versionRegexes, userAgent);
      return {
        current: os.name,
        version: version
      };
  ...
  var $_f4o8wtwpjkvrion6 = {
    browsers: constant(browsers),
    oses: constant(oses)
  };

  var detect$2 = function (userAgent) {
    var browsers = $_f4o8wtwpjkvrion6.browsers();
    var oses = $_f4o8wtwpjkvrion6.oses();
    var browser = $_eevh8ewojkvriomz.detectBrowser(browsers, userAgent).fold($_foq5fjwkjkvriomn.unknown, $_foq5fjwkjkvriomn.nu);
    var os = $_eevh8ewojkvriomz.detectOs(oses, userAgent).fold($_7mzn3owmjkvrioms.unknown, $_7mzn3owmjkvrioms.nu);
  ...
  var $_2gxkjawjjkvriomm = { detect: detect$2 };

  var detect$3 = cached(function () {
    var userAgent = navigator.userAgent;
    return $_2gxkjawjjkvriomm.detect(userAgent);
  });
  var $_3oj11nwijkvriomj = { detect: detect$3 };

  var ELEMENT = $_djmpcaw5jkvriol8.ELEMENT;
  var DOCUMENT = $_djmpcaw5jkvriol8.DOCUMENT;
  ...
  var ieContains = function (e1, e2) {
    return $_asd66cwejkvriome.documentPositionContainedBy(e1.dom(), e2.dom());
  };
  var browser = $_3oj11nwijkvriomj.detect().browser;
  var contains$2 = browser.isIE() ? ieContains : regularContains;
  var $_mhpvkwdjkvriom3 = {
    eq: eq,
    isEqualNode: isEqualNode,
    member: member,
    contains: contains$2,
    is: $_3wp72bwtjkvrionh.is
  };
  ...
  var findIndex$1 = function (element) {
    return parent(element).bind(function (p) {
      ...
      return findIndex(kin, function (elem) {
        return $_mhpvkwdjkvriom3.eq(element, elem);
      });
    });
  };
  ...
  var siblings = function (element) {
    var filterSelf = function (elements) {
      return filter(elements, function (x) {
        return !$_mhpvkwdjkvriom3.eq(element, x);
      });
    };
  ...
  var prevSiblings = function (element) {
    return reverse($_dv520kwcjkvriom2.toArray(element, prevSibling));
  };
  var nextSiblings = function (element) {
    return $_dv520kwcjkvriom2.toArray(element, nextSibling);
  };
  ...
  var all$1 = function (predicate) {
    return descendants($_9dp4ouw2jkvriokv.body(), predicate);
  };
  var ancestors = function (scope, predicate, isRoot) {
    return filter($_3h1drtw6jkvriolb.parents(scope, isRoot), predicate);
  };
  var siblings$1 = function (scope, predicate) {
    return filter($_3h1drtw6jkvriolb.siblings(scope), predicate);
  };
  var children$1 = function (scope, predicate) {
    return filter($_3h1drtw6jkvriolb.children(scope), predicate);
  };
  var descendants = function (scope, predicate) {
    var result = [];
    each($_3h1drtw6jkvriolb.children(scope), function (x) {
      if (predicate(x)) {
  ...
  var all$2 = function (selector) {
    return $_3wp72bwtjkvrionh.all(selector);
  };
  var ancestors$1 = function (scope, selector, isRoot) {
    return $_4hhgfuw1jkvriokq.ancestors(scope, function (e) {
      return $_3wp72bwtjkvrionh.is(e, selector);
    }, isRoot);
  };
  var siblings$2 = function (scope, selector) {
    return $_4hhgfuw1jkvriokq.siblings(scope, function (e) {
      return $_3wp72bwtjkvrionh.is(e, selector);
    });
  };
  var children$2 = function (scope, selector) {
    return $_4hhgfuw1jkvriokq.children(scope, function (e) {
      return $_3wp72bwtjkvrionh.is(e, selector);
    });
  };
  var descendants$1 = function (scope, selector) {
    return $_3wp72bwtjkvrionh.all(selector, scope);
  };
  var $_7992tmw0jkvrioko = {
    all: all$2,
  ...
  var select = function (selector, root) {
    return map($_7992tmw0jkvrioko.descendants(Element$$1.fromDom(root), selector), function (element) {
      return element.dom();
    });
  };
  ...
  var $_7c6yayvxjkvriok3 = { find: find$3 };
  ...
  var setupAutoCompleteHandler = function (ctrl, editorSettings, bodyElm, fileType) {
    var autocomplete = function (term) {
      var linkTargets = $_7c6yayvxjkvriok3.find(bodyElm);
  ...
  var first$1 = function (predicate) {
    return descendant($_9dp4ouw2jkvriokv.body(), predicate);
  };
  ...
  var sibling = function (scope, predicate) {
    ...
    return child$1(Element$$1.fromDom(element.parentNode), function (x) {
      return !$_mhpvkwdjkvriom3.eq(scope, x) && predicate(x);
    });
  };
  ...
  var first$2 = function (selector) {
    return $_3wp72bwtjkvrionh.one(selector);
  };
  var ancestor$1 = function (scope, selector, isRoot) {
    return $_8kd63vwzjkvrioo2.ancestor(scope, function (e) {
      return $_3wp72bwtjkvrionh.is(e, selector);
    }, isRoot);
  };
  var sibling$1 = function (scope, selector) {
    return $_8kd63vwzjkvrioo2.sibling(scope, function (e) {
      return $_3wp72bwtjkvrionh.is(e, selector);
    });
  };
  var child$2 = function (scope, selector) {
    return $_8kd63vwzjkvrioo2.child(scope, function (e) {
      return $_3wp72bwtjkvrionh.is(e, selector);
    });
  };
  var descendant$1 = function (scope, selector) {
    return $_3wp72bwtjkvrionh.one(selector, scope);
  };
  var closest$1 = function (scope, selector, isRoot) {
    return ClosestOrAncestor($_3wp72bwtjkvrionh.is, ancestor$1, scope, selector, isRoot);
  };
  var $_c2ravgwyjkvrioo0 = {
    first: first$2,
    ancestor: ancestor$1,
    sibling: sibling$1,
    child: child$2,
  ...
  var $_55w8chx1jkvriooi = { register: register };
  ...
  var $_dsyctqx3jkvriool = { register: register$1 };
  ...
  var $_2ixo6qx4jkvriooo = { register: register$2 };
  ...
  var $_483k31x5jkvrioor = { register: register$3 };
  ...
  var $_4d8fe0x6jkvriooy = { register: register$4 };
  ...
  var $_aurf4jx7jkvriop0 = { register: register$5 };
  ...
  var $_6ms732x8jkvriop4 = { register: register$6 };
  ...
  var $_fct3ebx9jkvriop7 = { register: register$7 };
  ...
  var $_f5cs2ixajkvriop8 = { register: register$8 };
  ...
  var setupUiContainer = function (editor) {
    if (editor.settings.ui_container) {
      global$8.container = $_c2ravgwyjkvrioo0.descendant(Element$$1.fromDom(document.body), editor.settings.ui_container).fold(constant(null), function (elm) {
        return elm.dom();
      });
    }
  };
  ...
  var setup$1 = function (editor) {
    ...
    setupEnvironment();
    $_4d8fe0x6jkvriooy.register(editor);
    $_55w8chx1jkvriooi.register(editor);
    $_6ms732x8jkvriop4.register(editor);
    $_fct3ebx9jkvriop7.register(editor);
    $_2ixo6qx4jkvriooo.register(editor);
    $_dsyctqx3jkvriool.register(editor);
    $_483k31x5jkvrioor.register(editor);
    $_f5cs2ixajkvriop8.register(editor);
    $_aurf4jx7jkvriop0.register(editor);
  };
  var $_c9yzaswxjkvrionv = { setup: setup$1 };
  ...
  var getApi = function () {
    return {
      ...
      ReflowQueue: $_fbht9uuxjkvriogu,
      Control: Control$1,
      Factory: global$4,
      KeyboardNavigation: KeyboardNavigation,
      Container: Container,
      DragHelper: DragHelper,
      Scrollable: $_cyh8w9uzjkvrioh1,
      Panel: Panel,
      Movable: $_fzqoxaukjkvrioff,
      Resizable: $_471alwv1jkvrioh7,
      ...
      FormatControls: $_c9yzaswxjkvrionv,
  ...
  global.add('modern', function (editor) {
    $_c9yzaswxjkvrionv.setup(editor);
    return $_9fo8vrtqjkvriod3.get(editor);
  });
  function Theme () {
  }
