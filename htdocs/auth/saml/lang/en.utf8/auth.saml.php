...
$string['logintolinkdesc'] = '<p><b>You are currently connected with remote user %s.  Please login with your local account to link them together, or register if you do not currently have an account on %s.</b></p>';
