...
$string['syncuserscreate'] = 'Auto-create accounts in cron';
$string['syncuserscron'] = 'Sync accounts automatically via cron job';
$string['syncusersextrafilterattribute'] = 'Additional LDAP filter for sync';
$string['syncuserssettings'] = 'Account sync';
$string['syncusersupdate'] = 'Update account information in cron';
