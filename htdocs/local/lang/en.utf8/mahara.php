...
$string['passworddescription.ul'] = 'It must contain <ul><li>upper case letters [A-Z]</li><li>lower case letters [a-z]</li></ul>';
$string['passworddescription.uln'] = 'It must contain at minimum <ul><li>1 upper case letter [A-Z]</li><li>1 lower case letter [a-z]</li><li>1 number [0-9]';
$string['passworddescription.ulns'] = 'It must contain at minimum <ul><li>1 upper case letter [A-Z]</li><li>1 lower case letter [a-z]</li><li>1 number [0-9]</li><li>1 symbol, e.g. ! . @ # $ & * - _ </li></ul>';
